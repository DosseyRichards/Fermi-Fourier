...
- **Every call to a Fourier contract is a WaveLedger transaction, and
  every transaction is signed with ML-DSA-87 (NIST FIPS 204)** — a
  post-quantum signature scheme. So inside your contract, `caller()` is
  a **post-quantum-authenticated identity**. When you write
